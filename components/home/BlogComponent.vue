      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 col-xs-12">
          <div class="blog-item">
            <div class="blog-image">
              <a href="#">
                <img alt="" class="img-fluid" src="assets/img/blog/img-1.jpg">
              </a>
            </div>
            <div class="descr">
              <div class="icon">
        ...
        <div class="col-lg-4 col-md-6 col-xs-12">
          <div class="blog-item">
            <div class="blog-image">
              <a href="#">
                <img alt="" class="img-fluid" src="assets/img/blog/img-2.jpg">
              </a>
            </div>
            <div class="descr">
              <div class="icon">
        ...
        <div class="col-lg-4 col-md-6 col-xs-12">
          <div class="blog-item">
            <div class="blog-image">
              <a href="#">
                <img alt="" class="img-fluid" src="assets/img/blog/img-3.jpg">
              </a>
            </div>
            <div class="descr">
              <div class="icon">
        ...
        <div class="col-12 text-center">
          <a class="btn btn-common" href="#">View all Blog</a>
        </div>
      </div>
    </div>
  </section>
